    ...
    <div className="flex justify-between p-3 justify-items-center px-12 relative top-0 right-0 items-center w-full " >
       ...
       <ul className="flex items-center text-[15px]  text-[#333] ">
        <li  id='hovered' className={`${poppins.className} p-2 px-6 hover:cursor-pointer delay-500 duration-100
         ...
         onClick={()=>{  seta(prev=>prev=!prev);setclicked([false,false,false,false,false,false]); setRoute("Home")  }}
         >Home</li>
        <li  id='hovered' className={`${poppins.className} p-2 px-6 hover:cursor-pointer delay-500 duration-100 relative
         ...
         onClick={()=>{  b=!b; setclicked([false,b,false,false,false,false]); seta(false);setRoute("About")  }}
         >About</li>
        ...
        onClick={()=>{  c=!c; setclicked([false,false,c,false,false,false]);seta(false);setRoute("Portfolio")  }}
        >Portfolio</li>
        <li  id='hovered' className={` ${poppins.className} p-2 px-6 hover:cursor-pointer delay-500 duration-100
         relative z-10 hover:text-white  ${Clicked[3] && " bg-[#333]  text-white" } `}
         onClick={()=>{  d=!d; setclicked([false,false,false,d,false,false]);seta(false);setRoute("Service") }}
         >Service</li>
        <li  id='hovered' className={` ${poppins.className} p-2  px-6 hover:cursor-pointer delay-500 duration-100
         relative z-10 hover:text-white  ${Clicked[4] && " bg-[#333]  text-white" }`}
         onClick={()=>{  e=!e; setclicked([false,false,false,false,e,false]);seta(false);setRoute("New") }}
         >New</li>
        <li  id='hovered' className={` ${poppins.className} p-2  px-6 hover:cursor-pointer delay-500 duration-100 
        relative z-10 hover:text-white  ${Clicked[5] && " bg-[#333]  text-white  " } `} 
        onClick={()=>{  f=!f; setclicked([false,false,false,false,false,f]);seta(false);setRoute("Contact") }}
        >Contact</li>
       </ul>
    </div>
        );
